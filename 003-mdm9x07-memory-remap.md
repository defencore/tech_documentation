...
00001208: 303a 7379 7374 656d 0000 0000 0000 0000 b404 0000 4c03 0000 ff01 0000  0:system............L.......
          ...
          │    │                                  │         └─────────────────── Length = Length/(4096*64) => Little Endian (DCBA)
          │    │                                  └───────────────────────────── Offset = Offset/(4096*64) => Little Endian (DCBA)
          │    └──────────────────────────────────────────────────────────────── Partition Name
          └───────────────────────────────────────────────────────────────────── Flash
```
### Example
...
## AFTER
```
└─$ xxd -s $((0x1010)) -l $((28*15)) -c 28 EC25EFAR06A01M4G_TRB140/update/firehose/mibib.bin
00001010: 303a 5342 4c00 0000 0000 0000 0000 0000 0000 0000 0500 0000 ff01 0000  0:SBL.......................
0000102c: 303a 4d49 4249 4200 0000 0000 0000 0000 0500 0000 0500 0000 ff01 ff00  0:MIBIB.....................
00001048: 303a 4546 5332 0000 0000 0000 0000 0000 0a00 0000 5800 0000 ff01 ff00  0:EFS2..............X.......
00001064: 303a 5241 5744 4154 4100 0000 0000 0000 6200 0000 0c00 0000 ff01 0000  0:RAWDATA.......b...........
00001080: 303a 545a 0000 0000 0000 0000 0000 0000 6e00 0000 0500 0000 ff01 0000  0:TZ............n...........
0000109c: 303a 5250 4d00 0000 0000 0000 0000 0000 7300 0000 0500 0000 ff01 0000  0:RPM...........s...........
000010b8: 303a 6162 6f6f 7400 0000 0000 0000 0000 7800 0000 0500 0000 ff01 0000  0:aboot.........x...........
000010d4: 303a 6d6e 665f 696e 666f 0000 0000 0000 7d00 0000 0500 0000 ff01 0000  0:mnf_info......}...........
000010f0: 303a 626f 6f74 5f63 6f6e 6669 6700 0000 8200 0000 0500 0000 ff01 0000  0:boot_config...............
0000110c: 303a 626f 6f74 5f61 0000 0000 0000 0000 8700 0000 2400 0000 ff01 0000  0:boot_a............$.......
00001128: 303a 626f 6f74 5f62 0000 0000 0000 0000 ab00 0000 2400 0000 ff01 0000  0:boot_b............$.......
00001144: 303a 6d6f 6465 6d00 0000 0000 0000 0000 cf00 0000 f000 0000 ff01 0000  0:modem.....................
00001160: 303a 726f 6f74 6673 5f61 0000 0000 0000 bf01 0000 dd01 0000 ff01 0000  0:rootfs_a..................
0000117c: 303a 726f 6f74 6673 5f62 0000 0000 0000 9c03 0000 dd01 0000 ff01 0000  0:rootfs_b..................
00001198: 303a 7374 6f72 6167 6500 0000 0000 0000 7905 0000 8702 0000 ff01 0000  0:storage.......y...........
```

# not working!
```
patch 0x3000 offset in mibib
```
